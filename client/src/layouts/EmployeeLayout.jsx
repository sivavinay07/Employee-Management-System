...
import { Clock, LogOut, LayoutDashboard, Calendar, FileText, Menu, X } from 'lucide-react';
...
const EmployeeLayout = () => {
  ...
  const navItems = [
    ...
    { name: 'Leave Requests', path: '/employee/leaves', icon: Calendar },
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col md:flex-row">
      ...
      <div className="md:hidden flex items-center justify-between p-4 bg-white border-b border-gray-200">
        <span className="text-xl font-bold text-primary-600">Employee Portal</span>
